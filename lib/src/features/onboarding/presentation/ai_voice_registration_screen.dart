...
class AiVoiceRegistrationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AiVoiceRegistrationScreen> createState() => _AiVoiceRegistrationScreenState();
}

class _AiVoiceRegistrationScreenState extends ConsumerState<AiVoiceRegistrationScreen>
  ...
  void _startRecording() {
    ...
    debugPrint('Started recording for: ${_registrationFields[_currentFieldIndex]}');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          AccessibleTappable(
            semanticsLabel: 'Reset registration',
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    semanticsLabel: 'Instruction: Speak naturally and let AI handle the rest',
                  ),
                  ...
                  Text(
                    ...
                    semanticsLabel: _allQuestionsCompleted
                          ...
                          if (_voiceText.isNotEmpty) ...[
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                textAlign: TextAlign.center,
                                semanticsLabel: 'Captured response: $_voiceText',
                              ),
                            ),
                          ],
                        ],
                  ...
                  if (!_allQuestionsCompleted)
                    ...
                    SizedBox(
                      ...
                      child: AccessibleButton(
                        ...
                        semanticHint: 'Submit all voice recordings and continue to review',
